            ...
            <template #body>
                <div
                    ...
                    <h5
                        ...
                        {{ selectedEvent ? 'Edit Service' : 'Add Service' }}
                    </h5>
                                ...
                                <div v-for="(value, key) in calendarsEvents" :key="key" class="n-chk">
                                    <div :class="`form-check form-check-${value} form-check-inline`">
                                        <label
                                            ...
                                            :for="`modal${key}`">
                                            <span class="relative">
                                                <input type="radio" :name="'event-level'" :value="key"
                                                    :id="`modal${key}`" v-model="eventLevel"
                                                ...
                                                <span
                                                    ...
                                                    <span
                                                        class="w-2 h-2 bg-white rounded-full dark:bg-transparent"></span>
                                                </span>
                                            </span>
                                            {{ key }}
                                        </label>
                    ...
                    <div class="flex items-center gap-3 mt-6 modal-footer sm:justify-end">
                        ...
                        <button @click="handleAddOrUpdateEvent"
                            ...
                            {{ selectedEvent ? 'Update Changes' : 'Add Service' }}
                        </button>
