    ...
    <Modal v-if="false" @close="isUpdatePasswordModal = false">
      <template #body>
        <div
          ...
          <!-- close btn -->
          <button @click="isUpdatePasswordModal = false"
          ...
          <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
            <button @click="isUpdatePasswordModal = false" type="button"
            ...
            <button class="edit-button" type="submit" @click="updatePassword" :class="{ 'opacity-25': form.processing }"
